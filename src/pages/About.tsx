...
const About: React.FC = () => {
  const [processedMissionIcon, setProcessedMissionIcon] = useState<string>(missionIcon);
  const [isProcessing, setIsProcessing] = useState(false);

  // Process mission icon on component mount
  useEffect(() => {
    const processMissionIcon = async () => {
      if (isProcessing) return;
      setIsProcessing(true);
      
      try {
        const img = await loadImageFromSrc(missionIcon);
        const blob = await removeBackground(img);
        const processedUrl = URL.createObjectURL(blob);
        setProcessedMissionIcon(processedUrl);
      } catch (error) {
        ...
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="relative mb-16 rounded-xl overflow-hidden">
            ...
            <div className="relative z-10 text-center py-24 px-8">
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-foreground mb-6 font-montserrat">
                About Our <span className="text-primary">Platform</span>
              </h1>
              <p className="text-lg md:text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed font-open-sans">
                The leading creator client platform bridging creative minds with business needs through innovative collaboration tools and secure dashboards.
              </p>
            </div>
          </div>
          ...
          <section className="mb-16">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-12">
              ...
              <GlassCard className="p-8 text-center">
                <div className="w-16 h-16 rounded-full bg-gradient-primary flex items-center justify-center mx-auto mb-6 p-3">
                  <img 
                    src={processedMissionIcon} 
                    alt="Mission lightbulb icon"
                    className="w-full h-full object-contain"
                  />
                </div>
                <h3 className="text-2xl font-bold text-foreground mb-4">Our Mission</h3>
                <p className="text-lg text-muted-foreground leading-relaxed">
                  <strong className="text-primary">Bridging creative minds with business needs</strong> through our innovative creator client platform. We connect talented professionals with meaningful opportunities, fostering collaboration that drives innovation and success.
                </p>
              </GlassCard>
              ...
              <GlassCard className="p-8 text-center">
                ...
                <p className="text-lg text-muted-foreground leading-relaxed">
                  <strong className="text-primary">A world where talent thrives</strong> and creativity knows no boundaries. We envision a global community where every creator finds their ideal client and every project reaches its full potential through seamless collaboration.
                </p>
              </GlassCard>
            </div>

            {/* History Section with Team Photo */}
            <GlassCard className="p-8 lg:p-12">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
                <div>
                  <h3 className="text-2xl font-bold text-foreground mb-4">Our Story</h3>
                  <p className="text-lg text-muted-foreground leading-relaxed mb-6">
                    <strong className="text-primary">Founded in 2023 to revolutionize collaborations</strong>, our creator client platform emerged from a simple yet powerful vision: to eliminate the barriers between creative talent and business opportunities.
                  </p>
                  <p className="text-muted-foreground leading-relaxed">
                    What started as a small team of passionate individuals has grown into a thriving community that serves thousands of creators and clients worldwide. We continue to innovate and improve our platform, always keeping our users' success at the heart of everything we do.
                  </p>
                </div>
          ...
          <section className="mb-16">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
                The passionate individuals behind our creator client platform mission to revolutionize creative collaboration
              </p>
            </div>
          ...
          <section className="text-center">
            <GlassCard className="p-8 md:p-12 max-w-4xl mx-auto">
              ...
              <p className="text-lg text-muted-foreground mb-8 max-w-2xl mx-auto leading-relaxed">
                Whether you are a creator looking for exciting projects or a client seeking talented professionals, 
                our creator client platform is here to help you succeed and thrive.
              </p>
